...
5. Read `references/docs-feature-write-handoff.md`.
6. Read and apply `docs-feature-write`, passing the evidence bundle.
...
- Do not write documentation in this skill; `docs-feature-write` owns that.
